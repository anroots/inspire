...
<div class="tabbable tabs-left">
	...
	<div class="tab-content">
		...
		<div class="tab-pane active" id="tab-about">
			...
			<p><?=__('There\'s also an Android app (min required OS version 1.6) that\'s still under heavy development.')
				?></p>
			<a href="<?=URL::base()?>assets/Inspire-1.1.apk" title="<?=__('Download Android App')?>" class="pull-right">
				<img src="<?=URL::base()?>assets/img/android_launcher.png" alt="Android"/>

				<p class="help-block"><?=__('Download app')?></p>
			</a>
		</div>
	</div>
</div>
