<h1>Rakendus "<?=Kohana::$config->load('app.title')?>"</h1>
...
<div class="tooltips">
    ...
    <p>
        Improviseerijatele ei valmista mingit raskust asjade väljamõtelmine, kuid mõnikord jääb siiski inspiratsioonist puudu või tekivad ideed samast valdkonnast.
        Kasuta vasakul olevaid kategooriaid juhusliku sõna küsimiseks.
    </p>
